...
class IsStaff(permissions.BasePermission):
    """
    Permission personnalisée pour vérifier si l'utilisateur est staff (chauffeur, caissier ou admin).
    """
...
class CanScanTickets(permissions.BasePermission):
    """
    Permission pour scanner les tickets (chauffeurs et staff d'agence).
    """
...
# Permissions pré-configurées pour une utilisation facile
...
# core/permissions.py - Ajout de la permission manquante
